...
- ATX Concepts Reference — `../Reference/atx/atx-concepts.md` — the three production factors, lived vs documented work, compounding thesis
- ATX Business Assessment Reference — `../Reference/atx/atx-assessment.md` — the four-phase ATX assessment methodology
- ATX Agent Mapping Reference — `../Reference/atx/atx-agent-mapping.md` — mapping cognitive work to agent designs
- ATX Use Case Scoring Reference — `../Reference/atx/atx-scoring.md` — volume × value, delegation suitability scoring
- ATX Economics Reference — `../Reference/atx/atx-economics.md` — economics of digital labour (you'll use this more in Week 4)
...
- Build-loop diagnostic taxonomy — `../Reference/spec-ambiguity-vs-builder-mistakes.md`
